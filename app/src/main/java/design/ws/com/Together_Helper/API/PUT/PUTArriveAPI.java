...
public class PUTArriveAPI extends AsyncTask<Integer,Void,String> {

    protected String doInBackground(Integer... unused) {

        int volunteerid = unused[0];

        Log.d("CANCEL_vol", String.valueOf(volunteerid));


        String content = executeClient(volunteerid);
        return content;
    }
    ...
    // 실제 전송하는 부분
    public String executeClient(int volunteerid) {
        ...
        // Post객체 생성
        HttpPut httpPost = new HttpPut("http://210.89.191.125/api/volunteer/arrive");
